 ...
 * for each, the other party, and what is being asked of the court.
 *
 ...
 * catalogue is in that position today. The other two are null when their
 * extraction failed, and in both cases that is a different thing from an answer
 * with nothing in it: a narrative that describes no defendant arrives as twelve
