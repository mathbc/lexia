...
export interface LegalCaseStep {
    label: string
    description: string
}
                        ...
                        <li key={step.label} className="flex min-w-0 shrink-0 lg:flex-none">
                            <button
                                ...
                                className={cn(
                                    ...
                                    enabled ? 'hover:bg-accent' : 'cursor-not-allowed opacity-60',
                                )}
                            >
                                ...
                                <span className="flex flex-col items-center">
                                    <span
                                        className={cn(
                                            ...
                                            active && 'border-primary bg-background text-foreground ring-2 ring-ring/40',
                                ...
                                <span className={cn('min-w-0 pb-1', !last && 'lg:pb-6')}>
                                    <span
                                        className={cn(
