...
/**
 * O diálogo modal do shadcn/ui — o mesmo primitivo do `Sheet`, centrado em vez
 * de ancorado na borda.
 *
 * Existe para a tarefa curta que não merece uma troca de página: cadastrar um
 * cliente sem sair do formulário da peça, por exemplo. O conteúdo é uma coluna
 * flexível com altura máxima, de modo que um formulário longo role por dentro
    ...
    return (
        <DialogPrimitive.Portal data-slot="dialog-portal">
            ...
            <DialogPrimitive.Content
                ...
                className={cn(
                    'fixed top-1/2 left-1/2 z-50 flex w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-xl border bg-background p-6 shadow-lg duration-200',
                    // `svh` e não `vh`: no celular a barra do navegador come a
                    // diferença e o rodapé do diálogo fica fora da tela.
