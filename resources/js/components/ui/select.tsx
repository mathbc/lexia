    ...
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                ...
                // O valor precisa poder encolher: `whitespace-nowrap` no gatilho dá a ele
                // um min-content do tamanho do rótulo, e sem `min-w-0` o flex se
                // recusa a cortar — o gatilho estoura o cartão em vez de truncar.
                'data-[placeholder]:text-muted-foreground *:data-[slot=select-value]:min-w-0 *:data-[slot=select-value]:line-clamp-1',
