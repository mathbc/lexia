...
function SidebarProvider({
    ...
    // Estado interno quando não é controlado de fora.
    ...
    const setOpen = React.useCallback(
        (value: boolean | ((value: boolean) => boolean)) => {
            ...
            // Um cookie, e não localStorage: o servidor pode lê-lo e devolver a
            // página já com o menu no estado certo, sem piscar na hidratação.
...
function Sidebar({
    ...
    return (
        <div
            ...
            data-slot="sidebar"
        >
            {/* O primeiro filho é só o espaço que o menu ocupa no fluxo; o
                segundo é o menu em si, fixo. Separá-los é o que permite animar
                a largura sem empurrar o conteúdo em dois tempos. */}
            <div
...
function SidebarMenuButton({
    ...
    asChild?: boolean
    isActive?: boolean
    /** Mostrado só com o menu recolhido, onde o rótulo não cabe. */
...
function SidebarMenuSkeleton({
    ...
    // Largura aleatória, fixada uma vez, para o esqueleto não parecer uma tabela.
